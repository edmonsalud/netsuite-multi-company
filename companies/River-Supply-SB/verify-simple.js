...
const query = "SELECT id, entityid, companyname, salesrep FROM customer WHERE id = 4038";
console.log('Verifying salesrep update for customer 4038...\n');
