...
function(serverWidget, search, log, redirect, record, url, format) {
    ...
    function createForm(context) {
        ...
        // Add the modern form HTML structure - MODIFIED to make customer name required
            ...
            <div class="modern-container">
                ...
                <div class="form-card">
                    <div class="instructions">
                        ...
                        <p>🔐 Customer name must match the name on the sales order for security verification.</p>
                    </div>
                    ...
                    <form id="orderResponseForm">
                        ...
                        <!-- Customer Name Field - NOW REQUIRED for verification -->
                        <div class="form-group">
                            <label class="form-label">
                                Customer Name
                                <span class="required-indicator">*</span>
                            ...
                            <input type="text" 
                                   ...
                                   class="modern-input" 
                                   placeholder="Enter customer name exactly as shown on order"
                                   name="custpage_customer_name"
                                   required>
                            <div class="help-text">Must match the customer name on the sales order (not case sensitive)</div>
                        </div>
            ...
            <script>
                (function() {
                    ...
                    form.addEventListener('submit', function(e) {
                        ...
                        if (!customerName) {
                            alert('Please enter the customer name as shown on the sales order.');
        ...
        // Hidden fields for NetSuite form processing
        ...
        // ADDED: Hidden field for customer name
        const hiddenCustomerName = form.addField({
            id: 'custpage_customer_name',
            type: serverWidget.FieldType.TEXT,
            label: 'Customer Name'
        });
        hiddenCustomerName.updateDisplayType({
            displayType: serverWidget.FieldDisplayType.HIDDEN
        });
    ...
    function handleFormSubmission(context) {
        ...
        const customerName = request.parameters.custpage_customer_name; // Now used for validation
        ...
        try {
            ...
            if (!orderNumber) {
                throw new Error('Order number is required. Please fill out the form and try again.');
            }
            ...
            // ADDED: Validate customer name (case-insensitive comparison)
            if (!customerName) {
                throw new Error('Customer name is required for verification.');
            }

            // Normalize both names for comparison (trim whitespace and convert to lowercase)
            const normalizedEnteredName = customerName.trim().toLowerCase();
            const normalizedActualName = actualCustomerName.trim().toLowerCase();

            if (normalizedEnteredName !== normalizedActualName) {
                throw new Error('Customer name does not match the order. Please enter the customer name exactly as it appears on the sales order. You entered: "' + customerName + '" but the order is for: "' + actualCustomerName + '"');
            }
            ...
            log.audit('Order Response Submitted Successfully', {
                ...
                customerNameVerified: true, // ADDED
            ...
            // Get clean script URL for redirect on success page
                    ...
                    <div class="success-message">
                        ...
                        <div class="success-details">
                            ...
                            <div class="detail-row">
                                ...
                                <span class="detail-value">` + actualCustomerName + `<span class="verified-badge">✓ Verified</span></span>
                            </div>
                            <div class="detail-row">
                        ...
                        <div class="action-buttons">
                            <button onclick="window.location.href='` + scriptUrl + `'" class="action-button primary-button">
