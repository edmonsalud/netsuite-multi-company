    ...
    function beforeLoad(scriptContext) {
        if (scriptContext.type == 'view'){
            ...
            scriptContext.form.addButton({
                ...
                functionName: `window.open("/app/site/hosting/scriptlet.nl?script=customscript_acs_sl_if_custom_pdf&deploy=customdeploy_acs_sl_if_custom_pdf&id=${objRec.id}&recordType=${objRec.type}&createdFrom=${fieldCreatedFrom}&itemIDs=${itemLinesWithModel.join()}&mode=string")`
            });
        }
    }
    return {
